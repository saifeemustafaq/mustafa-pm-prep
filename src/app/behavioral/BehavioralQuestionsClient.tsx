...
interface BehavioralQuestionsClientProps {
  questions: Question[];
}

export default function BehavioralQuestionsClient({ questions }: BehavioralQuestionsClientProps) {
  const [overallProgress, setOverallProgress] = useState(0);
  const config = categoryConfig['behavioral'];
    ...
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 text-lg mb-4">
          Practice answering questions about your past experiences and behaviors.
        </p>
